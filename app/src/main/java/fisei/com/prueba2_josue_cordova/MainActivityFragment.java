...
public class MainActivityFragment extends Fragment {
    private fisei.com.prueba2_josue_cordova.DoodleView doodleView; // handles touch events and draws
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        doodleView = (fisei.com.prueba2_josue_cordova.DoodleView) view.findViewById(R.id.doodleView);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.background_color:
                ColorDialogFragment backgroundColorDialog = new fisei.com.prueba2_josue_cordova.BackgroundColorDialogFragment();
                backgroundColorDialog.show(getFragmentManager(), "background color dialog");
                return true;
            case R.id.line_width:
                fisei.com.prueba2_josue_cordova.LineWidthDialogFragment widthDialog =
                        new fisei.com.prueba2_josue_cordova.LineWidthDialogFragment();
    ...
    public fisei.com.prueba2_josue_cordova.DoodleView getDoodleView() {
        return doodleView;
    }
